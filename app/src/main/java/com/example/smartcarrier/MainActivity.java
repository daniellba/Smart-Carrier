...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnForw, btnDisc, dManual_Btn, dSettings_Btn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnForw = findViewById(R.id.Follow_Me_Btn);
        btnDisc = findViewById(R.id.btnDisc);
        dManual_Btn = findViewById(R.id.Manual_Btn);
        dSettings_Btn = findViewById(R.id.btnDisc);
        ...
        new ConnectBT().execute(); //pass the connection between activities
